...
export default function InboxPageLocalized() {
  ...
  const copy = byLanguage(language, {
    pl: { title: 'Smart Inbox', subtitle: 'Jedno miejsce na komentarze i wiadomosci z propozycjami odpowiedzi AI.', messages: 'wiadomosci', all: 'Wszystkie', unread: 'Nieprzeczytane', empty: 'Brak wiadomosci do wyswietlenia.', ai: 'Sugestia AI', approve: 'Zaakceptuj i wyslij', edit: 'Edytuj odpowiedz' },
    en: { title: 'Smart Inbox', subtitle: 'One place for comments and messages with AI reply suggestions.', messages: 'messages', all: 'All', unread: 'Unread', empty: 'No messages to display.', ai: 'AI suggestion', approve: 'Approve and send', edit: 'Edit reply' },
    es: { title: 'Bandeja inteligente', subtitle: 'Un lugar para comentarios y mensajes con sugerencias de respuesta AI.', messages: 'mensajes', all: 'Todas', unread: 'No leidos', empty: 'No hay mensajes para mostrar.', ai: 'Sugerencia AI', approve: 'Aceptar y enviar', edit: 'Editar respuesta' },
  });
