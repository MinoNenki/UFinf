...
export default function ContentFactory() {
  ...
  const copy = byLanguage(language, {
    pl: {
      title: 'Content Factory', subtitle: 'Jeden temat -> kompletny pakiet tresci na wszystkie platformy', steps: ['Wpisz temat', 'Sprawdz budzet', 'Odbierz tresci'], config: 'Konfiguracja tresci', topic: 'Temat / link / opis / pomysl na film', placeholder: 'np. Jak uzywac ChatGPT do tworzenia content strategii...', niche: 'Nisza', plan: 'Plan API', platforms: 'Platformy', budget: 'Szacowany koszt', limit: 'OK - w limicie planu', generate: 'Wygeneruj Pakiet Tresci', generating: 'Generuje pakiet...', emptyTitle: 'Wyniki pojawia sie tutaj', emptyText: 'Wpisz temat i kliknij "Wygeneruj Pakiet Tresci"', bestTime: 'Najlepszy czas', coach: 'Growth Coach', ideas: 'Kolejne pomysly', planTitle: 'PLAN DZIALANIA', ideasTitle: 'KOLEJNE POMYSLY', copied: 'Skopiowano', copyBtn: 'Kopiuj', hashtags: 'Hashtagi', error: 'Blad polaczenia z API.' },
    en: {
      title: 'Content Factory', subtitle: 'One topic -> complete content pack for every platform', steps: ['Enter topic', 'Check budget', 'Collect content'], config: 'Content setup', topic: 'Topic / link / description / video idea', placeholder: 'e.g. How to use ChatGPT for content strategy...', niche: 'Niche', plan: 'API plan', platforms: 'Platforms', budget: 'Estimated cost', limit: 'OK - within plan limit', generate: 'Generate Content Pack', generating: 'Generating pack...', emptyTitle: 'Results will appear here', emptyText: 'Enter a topic and click "Generate Content Pack"', bestTime: 'Best time', coach: 'Growth Coach', ideas: 'Next ideas', planTitle: 'ACTION PLAN', ideasTitle: 'NEXT IDEAS', copied: 'Copied', copyBtn: 'Copy', hashtags: 'Hashtags', error: 'API connection error.' },
    es: {
      title: 'Fabrica de contenido', subtitle: 'Un tema -> paquete completo de contenido para cada plataforma', steps: ['Introduce tema', 'Revisa presupuesto', 'Recoge contenido'], config: 'Configuracion de contenido', topic: 'Tema / link / descripcion / idea de video', placeholder: 'ej. Como usar ChatGPT para estrategia de contenido...', niche: 'Nicho', plan: 'Plan API', platforms: 'Plataformas', budget: 'Coste estimado', limit: 'OK - dentro del limite del plan', generate: 'Generar paquete de contenido', generating: 'Generando paquete...', emptyTitle: 'Los resultados apareceran aqui', emptyText: 'Introduce un tema y haz clic en "Generar paquete de contenido"', bestTime: 'Mejor hora', coach: 'Growth Coach', ideas: 'Siguientes ideas', planTitle: 'PLAN DE ACCION', ideasTitle: 'SIGUIENTES IDEAS', copied: 'Copiado', copyBtn: 'Copiar', hashtags: 'Hashtags', error: 'Error de conexion con la API.' },
  });
