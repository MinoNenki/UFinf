  ...
  return (
    <main className="page-bg">
      ...
      <section className="hero">
        ...
        <div className="hero-card"><div className="phone-mock"><div className="phone-notch" /><div className="phone-score-ring"><b>MVP</b><small>{copy.score}</small></div><div className="phone-coach-tip"><CalendarClock size={15} /> {copy.publishWindow}</div><div className="phone-mini-grid"><div className="phone-mini-card"><b>AI</b>Factory</div><div className="phone-mini-card"><b>Ready</b>to ship</div><div className="phone-mini-card"><b>Real</b>Data only</div><div className="phone-mini-card"><b>Sync</b>Platforms</div></div><button className="phone-publish-btn">✨ Publish Everywhere</button></div></div>
      </section>
