...
export default function LandingPageLocalized({ variant }: { variant: 'a' | 'b' }) {
  ...
  const copy = byLanguage(language, {
    pl: {
      ...
      pricing: { title: 'Globalne ceny gotowe do skali + kontrola kosztow AI', plans: [['Free', '$0', 'Start', '5 generacji treści/dzien'], ['Pro', '$24', 'Najlepszy start', '60 generacji treści/dzien'], ['Premium Plus', '$69', 'One Click Publish', '180 generacji treści/dzien'], ['Expert', '$119', 'Skala dla zespołu', '360 generacji treści/dzien']], choose: 'Wybierz plan', start: 'Zacznij teraz ->', topup: 'Pakiety jednorazowe kredytow contentu: +25/$9, +75/$19, +150/$39' },
      cta: { title: 'USInf.com: Twoj globalny system wzrostu creator-first.', text: 'Buduj audience i przychod szybciej dzięki hybrydowemu AI stackowi: jakość tam gdzie liczy się konwersja, optymalizacja kosztu tam gdzie liczy się skala.', growth: 'Uruchom panel growth', admin: 'Zobacz panel admina' },
    ...
    en: {
      ...
      pricing: { title: 'Global-ready pricing + strict AI cost control', plans: [['Free', '$0', 'Start', '5 content generations/day'], ['Pro', '$24', 'Best start', '60 content generations/day'], ['Premium Plus', '$69', 'One Click Publish', '180 content generations/day'], ['Expert', '$119', 'Team scale mode', '360 content generations/day']], choose: 'Choose plan', start: 'Start now ->', topup: 'One-time content credits: +25/$9, +75/$19, +150/$39' },
      cta: { title: 'USInf.com: your creator-first global growth system.', text: 'Build audience and revenue faster with a hybrid AI stack: premium quality where conversion matters, cost-optimized generation where scale matters.', growth: 'Open growth panel', admin: 'Open admin panel' },
    ...
    es: {
      ...
      pricing: { title: 'Precios globales listos para escalar + control de coste AI', plans: [['Free', '$0', 'Inicio', '5 generaciones de contenido/dia'], ['Pro', '$24', 'Mejor inicio', '60 generaciones de contenido/dia'], ['Premium Plus', '$69', 'One Click Publish', '180 generaciones de contenido/dia'], ['Expert', '$119', 'Escala para equipos', '360 generaciones de contenido/dia']], choose: 'Elegir plan', start: 'Empezar ahora ->', topup: 'Creditos de contenido unicos: +25/$9, +75/$19, +150/$39' },
      cta: { title: 'USInf.com: tu sistema global de crecimiento creator-first.', text: 'Construye audiencia e ingresos mas rapido con un stack AI hibrido: calidad premium donde importa la conversion y optimizacion de coste donde importa la escala.', growth: 'Abrir panel growth', admin: 'Abrir panel admin' },
